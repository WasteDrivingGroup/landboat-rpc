...
import netty.proto.custom.SimpleProto;
 ...
 * @date 2021/5/2
 **/
public class ClientBootstrap extends AbstractNettyClientBootstrap {
    ...
    public void start() throws InterruptedException {
        ...
        bootstrap.connect("localhost", 8888).addListener(new ChannelFutureListener() {
            @Override
        ...
        while (scanner.hasNext()) {
            ...
            channel.writeAndFlush(new SimpleProto(data));
        }
    }
}
